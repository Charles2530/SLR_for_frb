...
class VideoClassificationTest {
    ...
    companion object {
        private const val INPUT_FILE_NAME = "v2.mp4"
    }
...
//            "movinet_a0_stream_int8.tflite",
            "slr_cnn3d_epoch005_2.12.tflite",
//            "kinetics600_label_map.txt",
    ...
    fun testVideoClassifierWithExampleVideo() {
        ...
        assertEquals("Top1 category matches.", "tai chi", categories[0].label)
        assertThat("Score is larger than threshold.", categories[0].score, greaterThan(0.4f))
    }
