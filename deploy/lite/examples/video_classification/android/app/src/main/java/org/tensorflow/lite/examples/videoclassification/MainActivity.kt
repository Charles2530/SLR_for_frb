...
class MainActivity : AppCompatActivity() {
    companion object {
        ...
        private const val MODEL_SLR_CLASSIFICATION_FILE = "slr_cnn3d_epoch005.tflite"
        private const val MODEL_LABEL_FILE = "kinetics600_label_map.txt"
        private const val MODEL_SLR_LABEL_FILE = "slr_label_map.txt"//SLR_label
        ...
        //        private const val MAX_CAPTURE_FPS = 320
    ...
    private fun createClassifier() {
        synchronized(lock) {
            ...
            val modelFile = when (modelPosition) {
                ...
                2 -> MODEL_MOVINET_A2_FILE
                else -> MODEL_SLR_CLASSIFICATION_FILE
            }

            videoClassifier = VideoClassifier.createFromFileAndLabelsAndOptions(
                this,
                modelFile,
                MODEL_SLR_LABEL_FILE,//
//                MODEL_LABEL_FILE,//
                options
            )
