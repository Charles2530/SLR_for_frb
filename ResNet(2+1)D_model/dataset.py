...
class CSL_Isolated(Dataset):
    ...
    def read_images(self, folder_path):
        ...
        # print("###### images.dtype: " + str(images.dtype))
###### type(images): <class 'torch.Tensor'>
###### images.shape: torch.Size([3, 16, 128, 128])
###### images.size(): torch.Size([3, 16, 128, 128])
###### images.dtype: torch.float32
    ...
    def __getitem__(self, idx):
        # print("##########")
        # print(f"idx: {idx}")
        # print(f"self.videos_per_folder: {self.videos_per_folder}")
        # print(int(idx/self.videos_per_folder))
...
# 单输入
class newCSL_Isolated(Dataset):
    def __init__(self, data_path, label_path, frames=16, num_classes=500, train=True, transform=None):
        super(newCSL_Isolated, self).__init__()
        self.data_path = data_path
        self.label_path = label_path
        self.train = train
        self.transform = transform
